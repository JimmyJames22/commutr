        ...
        <div className="settings-form-group">
          ...
          <p className="edit-wrapper">
            <input
              type="number"
              name="capacity"
              className="capacity_box"
              id="capacity_box"
              readOnly="true"
              onChange={(e) =>
                setDetails({ ...details, carCapacity: e.target.value })
              }
              value={details.carCapacity}
            />
            <button
              className="edit-btn"
              onClick={() => {
  ...
  return (
    <div className="settings-wrapper">
      ...
      <div className="settings-info-wrapper">
          ...
          <div className="settings-form-group">
            ...
            <p className="edit-wrapper">
              ...
              <button
                className="edit-btn"
                onClick={() => {
                  changeElement("address_box", details.address, "address");
                }}
              >
                edit
              </button>
          ...
          <div className="settings-form-group">
            ...
            <p className="edit-wrapper">
              ...
              <button
                className="edit-btn"
                onClick={() => {
                  changeElement("phone_box", details.phone, "phone");
                }}
              >
                edit
              </button>
          ...
          <div className="settings-form-group">
            ...
            <p className="edit-wrapper">
              <input
                ...
                id="status_box"
                readOnly="true"
                value={data.isDriver ? "Driver" : "Passenger"}
              />
              <button
                className="edit-btn"
                onClick={() =>
                  alert(
                    "Please contact administrator if you wish to change your driving status"
                  )
                }
              >
                edit
        ...
        <Quit id={data._id} isDriver={data.isDriver} />
      </div>
    </div>
  );
}
